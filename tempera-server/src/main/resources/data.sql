...
INSERT INTO USERX (ENABLED, FIRST_NAME, LAST_NAME, PASSWORD, USERNAME, CREATE_USER_USERNAME, CREATE_DATE, state, state_visibility) VALUES
    (TRUE, 'Maria', 'Theresa', '$2a$10$UEIwGPJpM6Kfdk3.c6RLDOTtpDfXymwkqAL5LpiRZgizuShpwlq7u', 'MariaTheresa', 'admin', '2016-01-01 00:00:00', 'OUT_OF_OFFICE', 'HIDDEN');
INSERT INTO USERX_USERX_ROLE (USERX_USERNAME, ROLES) VALUES
    ('MariaTheresa', 'MANAGER'), ('MariaTheresa', 'EMPLOYEE');
...
INSERT INTO groupx (id, group_lead_username, description, name) VALUES
    ...
    (-2, 'peterparker', 'this is also just for testing', 'Security Team'),
...
INSERT INTO access_point (id, is_healthy, enabled, room_room_id) VALUES
    ...
    ('789e4567-e89b-12d3-a456-426614174001', TRUE, TRUE, 'room_3'),
...
INSERT INTO TEMPERA_STATION (IS_HEALTHY, ENABLED, access_point_id, USER_USERNAME, ID) VALUES
    ...
    (FALSE, FALSE, '123e4567-e89b-12d3-a456-426614174001', 'user1', 'tempera_station_disabled'),
    (FALSE, FALSE, '123e4567-e89b-12d3-a456-426614174001', 'elvis', 'tempera_station_disabled_elvis'),
